...
% Simulation = 'GaussianTwoCarRCLinGrad';
% Simulation = 'GaussianSingle0V';
% Simulation = 'GaussianSingle1V';
% Simulation = 'ExpDoping';
% Simulation = 'PNJct';
% Simulation = 'PNJctEq';
 Simulation = 'PNJctEqBias';
% Simulation = 'SGTwoCarRC';
...
elseif strcmp(Simulation,'SGTwoCarRC')
    eval('SG2CarParasRCOnly');
end
